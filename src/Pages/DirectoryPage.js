  ...
  componentDidMount(){
    ...
    return (
      ...
      <div className="container">
       ...
       {this.props.plants.map(plant => <Card plant={plant} key={plant.id} addToCollection={this.props.addToCollection} updateCurrentUser={this.props.updateCurrentUser} setUserCollection={this.props.setUserCollection}/>)}
