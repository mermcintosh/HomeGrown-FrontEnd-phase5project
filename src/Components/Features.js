      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={4}>
          <Paper className={classes.paper}>
              ...
              <h2 className={classes.featureWords}>You no longer have to keep track of your plants' care instructions ever again! With your own personal profile, you can be sure that killing plants is behind you.</h2>
            </Paper>
        </Grid>
        <Grid item xs={4}>
          <Paper className={classes.paper}>
